package com.instructionnetwork.rezervacije.handlers;

import com.instructionnetwork.rezervacije.exceptions.*;
...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleReservationNotFountException(ReservationNotFoundException ex, WebRequest request) {
        ApiError apiError = getExceptionResponse(ex.getMessage(), HttpStatus.NOT_FOUND, request);
        return new ResponseEntity<>(apiError, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(NoReservationsForStudentException.class)
    protected ResponseEntity<Object> handleNoReservationsForStudentException(NoReservationsForStudentException ex, WebRequest request) {
        ApiError apiError = getExceptionResponse(ex.getMessage(), HttpStatus.NOT_FOUND, request);
        return new ResponseEntity<>(apiError, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(NoReservationsDefinedException.class)
    protected ResponseEntity<Object> handleNoReservationsDefinedException(NoReservationsDefinedException ex, WebRequest request) {
        ApiError apiError = getExceptionResponse(ex.getMessage(), HttpStatus.NOT_FOUND, request);
        return new ResponseEntity<>(apiError, HttpStatus.NOT_FOUND);
    }
