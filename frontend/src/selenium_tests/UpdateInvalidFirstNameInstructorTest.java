...
import java.net.URL;
public class UpdateInvalidFirstNameInstructorTest {
  ...
  @Test
  public void updateInvalidFirstNameInstructor() {
    ...
    driver.findElement(By.id("profilForma_name")).sendKeys("97g8bink");
    ...
    assertThat(driver.findElement(By.cssSelector(".ant-form-item-explain > div")).getText(), is("First name should contain only letters and {\\\', ., -}, with the first letter capitalized!"));
    driver.close();
  }
}
