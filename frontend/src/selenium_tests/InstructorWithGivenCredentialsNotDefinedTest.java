...
import java.net.URL;
public class InstructorWithGivenCredentialsNotDefinedTest {
  ...
  @Test
  public void instructorWithGivenCredentialsNotDefined() {
    ...
    driver.findElement(By.cssSelector(".ant-message-custom-content > span:nth-child(2)")).click();
    assertThat(driver.findElement(By.cssSelector(".ant-message-custom-content > span:nth-child(2)")).getText(), is("User (Instructor) with given credentials is not defined!"));
    driver.close();
  }
}
