...
import java.net.URL;
public class InvalidLastNameTest {
  ...
  public void invalidLastName() {
    ...
    driver.findElement(By.cssSelector(".ant-message-custom-content > span:nth-child(2)")).click();
    driver.findElement(By.cssSelector(".ant-message-custom-content > span:nth-child(2)")).click();
    assertThat(driver.findElement(By.cssSelector(".ant-message-custom-content > span:nth-child(2)")).getText(), is("Last name should contain only letters with the first letter capitalized!"));
    driver.close();
  }
}
