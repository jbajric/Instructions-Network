...
import java.net.URL;
public class AppointmentsElementsPresentTest {
  ...
  @Test
  public void appointmentsElementsPresent() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.cssSelector(".anticon-plus > svg"));
