...
import java.net.URL;
public class OpenTimetablePageStudentTest {
  ...
  @Test
  public void openTimetablePageStudent() {
    ...
    driver.findElement(By.cssSelector("#bodyMain > div > div")).click();
    driver.findElement(By.cssSelector("h5")).click();
    driver.findElement(By.cssSelector("h5")).click();
    {
      WebDriverWait wait = new WebDriverWait(driver, 6);
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("h5")));
    }
    driver.close();
  }
}
