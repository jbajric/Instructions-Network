...
import java.net.URL;
public class UsernameAlreadyTakenInstructorTest {
  ...
  @Test
  public void usernameAlreadyTakenInstructor() {
    driver.get("http://localhost:3000/registration");
    driver.manage().window().setSize(new Dimension(1536, 824));
    driver.findElement(By.id("normal_login_firstname")).click();
    driver.findElement(By.id("normal_login_firstname")).sendKeys("Irfan");
    driver.findElement(By.id("normal_login_lastname")).click();
    driver.findElement(By.id("normal_login_lastname")).sendKeys("Prazina");
    driver.findElement(By.id("normal_login_email")).click();
    driver.findElement(By.id("normal_login_email")).sendKeys("iprazina@gmail.com");
    ...
    assertTrue(driver.findElement(By.name("radiogroup")).isSelected());
    ...
    driver.findElement(By.cssSelector(".ant-message-custom-content > span:nth-child(2)")).click();
    assertThat(driver.findElement(By.cssSelector(".ant-message-custom-content > span:nth-child(2)")).getText(), is("Username already taken!"));
    driver.close();
  }
}
