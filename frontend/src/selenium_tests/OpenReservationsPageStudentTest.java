...
import java.net.URL;
public class OpenReservationsPageStudentTest {
  ...
  @Test
  public void openReservationsPageStudent() {
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, 6);
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".anticon-usergroup-add > svg")));
    }
    driver.close();
  }
}
