...
import java.net.URL;
public class OpenReservationsPageInstructorTest {
  ...
  @Test
  public void openReservationsPageInstructor() {
    ...
    driver.findElement(By.linkText("Reservations")).click();
    {
      ...
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("searchBarSubject")));
    }
    driver.close();
  }
}
