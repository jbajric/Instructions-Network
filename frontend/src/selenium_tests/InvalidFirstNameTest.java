...
import java.net.URL;
public class InvalidFirstNameTest {
  ...
  public void invalidFirstName() {
    ...
    driver.findElement(By.cssSelector(".ant-message-custom-content > span:nth-child(2)")).click();
    assertThat(driver.findElement(By.cssSelector(".ant-message-custom-content > span:nth-child(2)")).getText(), is("First name should contain only letters with the first letter capitalized!"));
    driver.close();
  }
}
