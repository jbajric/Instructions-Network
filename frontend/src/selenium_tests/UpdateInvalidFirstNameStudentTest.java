...
import java.net.URL;
public class UpdateInvalidFirstNameStudentTest {
  ...
  @Test
  public void updateInvalidFirstNameStudent() {
    ...
    driver.findElement(By.id("profilForma_name")).sendKeys("97t");
    driver.findElement(By.cssSelector(".ant-input-affix-wrapper-focused")).click();
    driver.findElement(By.cssSelector(".ant-form-item-explain")).click();
    assertThat(driver.findElement(By.cssSelector(".ant-form-item-explain > div:nth-child(2)")).getText(), is("First name should contain only letters and {\\\', ., -}, with the first letter capitalized!"));
    driver.close();
  }
}
