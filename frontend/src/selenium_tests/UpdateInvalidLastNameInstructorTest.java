...
import java.net.URL;
public class UpdateInvalidLastNameInstructorTest {
  ...
  @Test
  public void updateInvalidLastNameInstructor() {
    ...
    driver.findElement(By.id("profilForma_lastname")).sendKeys("9*/8+5613");
    driver.findElement(By.cssSelector(".ant-input-affix-wrapper-focused")).click();
    driver.findElement(By.cssSelector(".ant-form-item-explain > div")).click();
    assertThat(driver.findElement(By.cssSelector(".ant-form-item-explain > div")).getText(), is("Last name should contain only letters and {\\\', ., -}, with the first letter capitalized!"));
    driver.close();
  }
}
