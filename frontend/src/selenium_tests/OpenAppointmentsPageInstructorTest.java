...
import java.net.URL;
public class OpenAppointmentsPageInstructorTest {
  ...
  @Test
  public void openAppointmentsPageInstructor() {
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, 3);
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".anticon-plus > svg")));
    }
    driver.close();
  }
}
