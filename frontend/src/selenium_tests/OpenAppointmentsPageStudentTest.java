...
import java.net.URL;
public class OpenAppointmentsPageStudentTest {
  ...
  @Test
  public void openAppointmentsPageStudent() {
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, 6);
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".anticon-usergroup-add path")));
    }
    driver.close();
  }
}
