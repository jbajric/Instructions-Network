package com.instructionnetwork.raspored.handlers;

import com.instructionnetwork.raspored.exceptions.*;
...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(FreeTimeNotFoundException.class)
    protected ResponseEntity<Object> handleFreeTimeNotFoundException(FreeTimeNotFoundException ex, WebRequest request) {
        ApiError apiError = getExceptionResponse(ex.getMessage(), HttpStatus.NOT_FOUND, request);
        return new ResponseEntity<>(apiError, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(NoFreeTimesDefinedException.class)
    protected ResponseEntity<Object> handleNoFreeTimesDefinedException(NoFreeTimesDefinedException ex, WebRequest request) {
        ApiError apiError = getExceptionResponse(ex.getMessage(), HttpStatus.NOT_FOUND, request);
        return new ResponseEntity<>(apiError, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(NoFreeTimesForStudentException.class)
    protected ResponseEntity<Object> handleNoFreeTimesForStudentException(NoFreeTimesForStudentException ex, WebRequest request) {
        ApiError apiError = getExceptionResponse(ex.getMessage(), HttpStatus.NOT_FOUND, request);
        return new ResponseEntity<>(apiError, HttpStatus.NOT_FOUND);
    }
